...
class MockAircraftRequests:
    ...
    def get(self, var: str) -> Any:
        ...
        # ... (Outras variáveis omitidas por brevidade, assumindo o código original)
        return 0
...
def fetch_all_data():
    ...
    # Coleta de Status e Luzes e Lógica de Alertas (conforme o código original)
    ...
    # ... (restante da coleta de dados e alertas)
